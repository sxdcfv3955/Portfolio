		...
		<div id="sidebar-wrapper">
			<div class="side-top">
				...
				<ul class="sidebar-nav">
					...
					<li><a class="active" href="services2">유기견</a></li>
		...
		<div class="section 1st">
			<div class="container-fluid">
				<div class="section-title row text-center">
					...
					<h3>유기견</h3>
					<hr class="grd1">
					<p class="lead">유기동물 등록 분포</p>
					<jsp:include page="densityR.jsp"></jsp:include>
				</div>
			</div>
		</div>
			...
			<div class="container-fluid">
				<div class="section-title row text-center">
					...
					<div class="image-box text-center">
						<img src="resources/uploads/table2.png" alt="" width=90% />
					</div>
